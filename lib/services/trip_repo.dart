...
class TripRepository{
  ...
  Future<List<TripModel>> getAllTrips() async {
    try {
      final response = await _dio.get('/TripConrtoller/GetAllTrips');
  ...
  Future<TripModel> getTripsById(int id) async {
    try {
      final response = await _dio.get('/TripConrtoller/FindTripBy$id');
